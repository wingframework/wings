...
namespace Wings.Examples.UseCase.Server.Models
{
    public class Good
    {
        ...
        public virtual AttrCategory AttributeCategory { get; set; }
        ...
        public virtual List<GoodIssue> Issues { get; set; }


        public virtual List<GoodAttr> GoodAttrs { get; set; }

        public virtual List<GoodSpecification> GoodSpecifications { get; set; }
