...
namespace Wings.Examples.UseCase.Server.Migrations
{
    ...
    [Migration("20210614021244_change-attr-table3")]
    partial class changeattrtable3
    {
            ...
            modelBuilder.Entity("Wings.Examples.UseCase.Server.Models.Attr", b =>
                {
                    ...
                    b.Property<int?>("AttrCategoryId1")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Wings.Examples.UseCase.Server.Models.Attr", b =>
                {
                    ...
                    b.HasOne("Wings.Examples.UseCase.Server.Models.AttrCategory", null)
                        .WithMany("Attrs")
                        .HasForeignKey("AttrCategoryId1");
